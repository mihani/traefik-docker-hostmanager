...
```shell
docker network create hostmanager && docker run -d --name traefik-docker-hostmanager --restart=always -v /var/run/docker.sock:/var/run/docker.sock -p 443:443 --network hostmanager mihani/traefik-docker-hostmanager
```
